...
export default function Portfolio() {
  ...
  { icon: Smartphone, name: "Languages & AI", desc: "Python, Java, C++, Machine Learning" }
];

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white relative overflow-hidden scroll-smooth">
      {/* Enhanced Background Effects */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-white/5 rounded-full mix-blend-screen filter blur-3xl opacity-40 animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gray-400/10 rounded-full mix-blend-screen filter blur-3xl opacity-40 animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-gray-300/5 rounded-full mix-blend-screen filter blur-3xl opacity-30 animate-pulse"></div>
        
        {/* Floating code snippets - better positioned */}
        <div className="absolute top-32 right-20 p-4 backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 shadow-2xl animate-bounce font-mono text-sm text-white/70" style={{animationDuration: '3s'}}>
          {'<div />'}
        </div>
        <div className="absolute bottom-40 left-20 p-4 backdrop-blur-xl bg-white/5 rounded-xl border border-white/10 shadow-2xl animate-bounce font-mono text-xs text-gray-300/70" style={{animationDuration: '4s', animationDelay: '1s'}}>
          {'const x = 10;'}
        </div>
        <div className="absolute top-1/4 left-12 p-3 backdrop-blur-xl bg-white/5 rounded-xl border border-white/10 shadow-2xl animate-bounce font-mono text-sm text-white/60" style={{animationDuration: '5s', animationDelay: '0.5s'}}>
          {'()=>{}'}
        </div>
        <div className="absolute bottom-1/4 right-12 p-4 backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 shadow-2xl animate-bounce font-mono text-sm text-gray-200/70" style={{animationDuration: '3.5s', animationDelay: '2s'}}>
          {'{...props}'}
        </div>
        <div className="absolute top-3/4 right-32 p-3 backdrop-blur-xl bg-white/5 rounded-xl border border-white/10 shadow-2xl animate-bounce font-mono text-xs text-white/70" style={{animationDuration: '4.5s', animationDelay: '1.5s'}}>
          {'</>'}
        </div>
        <div className="absolute top-1/2 right-24 p-4 backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 shadow-2xl animate-bounce font-mono text-sm text-gray-300/70" style={{animationDuration: '4s', animationDelay: '0.8s'}}>
          {'[ ]'}
        </div>
      </div>

      {/* Navigation with enhanced glass */}
      <nav className="relative z-50 backdrop-blur-2xl bg-black/40 border-b border-white/10 shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#home" className="text-gray-300 hover:text-white transition font-medium drop-shadow-sm">Home</a>
              <a href="#about" className="text-gray-300 hover:text-white transition font-medium drop-shadow-sm">About</a>
              <a href="#projects" className="text-gray-300 hover:text-white transition font-medium drop-shadow-sm">Projects</a>
              <a href="#contact" className="text-gray-300 hover:text-white transition font-medium drop-shadow-sm">Contact</a>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden backdrop-blur-2xl bg-black/40 border-t border-white/10">
            <div className="px-4 py-4 space-y-3">
              <a href="#home" className="block text-gray-300 hover:text-white transition font-medium">Home</a>
              <a href="#about" className="block text-gray-300 hover:text-white transition font-medium">About</a>
              <a href="#projects" className="block text-gray-300 hover:text-white transition font-medium">Projects</a>
              <a href="#contact" className="block text-gray-300 hover:text-white transition font-medium">Contact</a>
            </div>
          </div>
        )}
      </nav>
...
<p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto drop-shadow-sm">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="#projects" className="group relative px-8 py-4 rounded-2xl backdrop-blur-xl bg-white/10 border-2 border-white/20 hover:bg-white/20 hover:shadow-2xl transition-all duration-300 flex items-center gap-2 text-white font-semibold shadow-xl overflow-hidden hover:scale-105 hover:-translate-y-1">
              ...
              <a href="#contact" className="group relative px-8 py-4 rounded-2xl bg-white text-black hover:bg-gray-200 font-semibold shadow-2xl hover:shadow-white/20 hover:scale-110 hover:-translate-y-1 transition-all duration-300 flex items-center gap-2 overflow-hidden">
      ...
      {/* About Section with layered glass */}
      ...
      {/* Projects Section with frosted glass cards */}
      <section id="projects" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div key={index} onClick={()=>{ window.location.href = project.link}} className="group backdrop-blur-2xl bg-white/5 border-2 border-white/10 rounded-3xl overflow-hidden hover:bg-white/10 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 cursor-pointer">
      ...
      {/* Contact Section with ultimate glass effect */}
        ...
        <div className="backdrop-blur-2xl bg-white/5 border-2 border-white/10 rounded-[3rem] p-8 md:p-12 text-center space-y-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center gap-6 mt-8">
              <a href="https://github.com/NaaluZeroNaalu/" target='_blank' className="group relative p-5 rounded-2xl backdrop-blur-xl bg-white/10 border-2 border-white/20 hover:bg-white/20 hover:shadow-2xl hover:scale-110 hover:-translate-y-2 transition-all duration-300 text-white overflow-hidden">
              ...
              <a href="https://www.linkedin.com/in/ajithkumarr2000/" target='_blank' className="group relative p-5 rounded-2xl backdrop-blur-xl bg-white/10 border-2 border-white/20 hover:bg-white/20 hover:shadow-2xl hover:scale-110 hover:-translate-y-2 transition-all duration-300 text-white overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
